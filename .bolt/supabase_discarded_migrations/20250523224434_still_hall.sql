/*
  ...
  2. Foreign Keys
    - countries.region_id references regions(id)
    - cities.country_id references countries(id) with CASCADE DELETE
    - Added CASCADE DELETE to ensure referential integrity
...
-- Cities table with CASCADE DELETE
