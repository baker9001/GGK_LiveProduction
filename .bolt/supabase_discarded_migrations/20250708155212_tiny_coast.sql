/*
  ...
  1. Changes
    - Ensure data_structures table has correct foreign key relationships
    - Update any references to edu_regions, edu_programs, edu_providers to use the correct table names
    - Force schema cache refresh to ensure PostgREST recognizes the relationships
