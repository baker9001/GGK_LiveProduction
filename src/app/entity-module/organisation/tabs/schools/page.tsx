...
const SchoolsTab = React.forwardRef<SchoolsTabRef, SchoolsTabProps>(({ companyId, refreshData }, ref) => {
  ...
  // ===== CORRECTED FETCH SCHOOLS WITH PROPER JUNCTION TABLE HANDLING =====
  ...
  }, [formData, selectedSchool, updateSchoolMutation, createSchoolMutation, branches]);
        ...
        {displayedSchools.map((school) => (
          ...
          >
            <div className="p-4">
              ...
              {(can('modify_school') && !school.readOnly) && (
        ...
        <Dialog open={showCreateModal || showEditModal} onOpenChange={(open) => {
          ...
          <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as any)}>
            ...
            <TabsContent value="basic" className="space-y-4">
              ...
              <FormField label="School Code" required>
                <Input
                  value={formData.code || ''}
