    ...
    <div className="min-h-screen relative flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div className="mt-8 bg-gray-900/50 backdrop-blur-md py-8 px-4 shadow-2xl sm:rounded-xl sm:px-10 border border-gray-700/50">
          {/* Info Message */}
          <div className="mb-6 bg-blue-500/10 backdrop-blur text-blue-400 p-4 rounded-lg border border-blue-500/20">
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium">Sign-in Information</p>
                <p className="text-xs mt-1 text-blue-300">
                  Use your registered email and password above, or click "Quick Dev Login" below for development access.
                </p>
              </div>
            </div>
          </div>
