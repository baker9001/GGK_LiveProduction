          ...
          <thead className="bg-gray-50 dark:bg-gray-900/50">
            <tr>
              <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider w-12">
                <input
                  type="checkbox"
                  className="h-4 w-4 text-[#99C93B] focus:ring-[#99C93B] border-gray-300 dark:border-gray-600 rounded opacity-0 cursor-default dark:bg-gray-700"
                  disabled
                />
              </th>
              ...
              {['Access', 'View', 'Create', 'Edit', 'Delete'].map((header, index) => (
                ...
                >
                  <div className="flex flex-col items-center">
                    ...
                    <input
                      type="checkbox"
                      className="h-4 w-4 text-[#99C93B] focus:ring-[#99C93B] border-gray-300 dark:border-gray-600 rounded dark:bg-gray-700"
