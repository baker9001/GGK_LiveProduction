  ...
  const renderDropdown = () => {
    ...
    const dropdownContent = (
      ...
      >
        ...
        <div className="overflow-auto scrollbar-thin scrollbar-thumb-gray-200 dark:scrollbar-thumb-gray-600 scrollbar-track-transparent !bg-white dark:!bg-gray-800">
